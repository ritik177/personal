...
const navigation = [
  { name: 'Artificial Intelligence', href: '#', current: false },
...
export default function Example() {
  return (
    <Disclosure as="nav" className="bg-gray-800 shadow-md fixed w-full z-10">
      {({ open }) => (
        <>
                  ...
                  {navigation.map((item) => (
                    <a
                      ...
                      className={classNames(
                        item.current ? 'bg-gray-900 text-white' : 'text-white hover:bg-lightBlue-500 hover:text-white',
